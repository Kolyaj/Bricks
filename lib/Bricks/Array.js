 ...
 *
 * @return {*} Последний элемент массива или undefined, если массив пуст.
 */
...
/**
 * Разворачивает вложенные массивы input, складывая результат в output.
 *
 * @param {Array} input Разворачиваемый массив.
 * @param {Number} [depth] Глубина разворачивания: 0 — элементы добавляются как есть; если не указан, разворачивается
 *      вся вложенность.
 * @param {Array} [output] Массив, в который складывается результат. Если не указан, создаётся новый.
 *
 * @return {Array} Развёрнутый массив.
 */
 ...
 *
 * @param {Array} array Массив.
 * @param {*} ...items Элементы, присутствие которых проверяется.
 *
 * @return {Boolean}
 */
