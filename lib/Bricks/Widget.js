...
//#include index.js::getPrototypeChain
//#include DOM.js::getEls::setStyle::getPos::getSize::classNameExists::addClassName::removeClassName::toggleClassName::remove::isAncestor
...
Bricks.Widget = Bricks.AbstractWidget.inherit({
    ...
    _fireEvent: function(event, data) {
        if (Bricks.Widget.superclass._fireEvent.apply(this, arguments)) {
            var listenerSets = Bricks.getPrototypeChain(this, 'Bricks_Widget__liveListeners');
