 ...
 * @class Bricks.Rnd
 *
 * Псевдослучайный генератор (Mersenne Twister, Mt19937) с настраиваемым seed.
 *
...
Bricks.Rnd = Bricks.create({
    ...
    /**
     * @param {Number} [seed] Начальное seed. Если не задан, используется текущее время.
     */
    ...
    /**
     * Инициализирует состояние генератора seed.
     *
     * @param {Number} seed Начальное seed, 32 бита.
     */
    init: function(seed) {
        this._mt[0] = seed >>> 0;
    ...
    /**
     * Инициализирует состояние генератора массивом целых чисел initKey.
     *
     * @param {Array} initKey Массив целых чисел, каждое 32 бита.
     * @param {Number} [keyLength] Длинна массива initKey.
     */
    ...
    /**
     * Возвращает псевдослучайное целое число в диапазоне от 0 до 2^32.
     *
     * @return {Number}
     */
    int32: function() {
    ...
    /**
     * Возвращает псевдослучайное число от 0 до 1, включая обе границы.
     *
     * @return {Number}
     */
    real1: function() {
    ...
    /**
     * Возвращает псевдослучайное число от 0 до 1, не включая ни одну из границ.
     *
     * @return {Number}
     */
    real3: function() {
    ...
    /**
     * Возвращает псевдослучайное число от 0 до 1, не включая 1 (эквивалент real2).
     *
     * @return {Number}
     */
    random: function() {
    ...
    /**
     * Возвращает псевдослучайный булеву.
     *
     * @param {Number} [likelihood] Вероятность true в процентах от 0 до 100. По умолчанию 50.
     *
     * @return {Boolean}
     */
    bool: function(likelihood) {
        // Не `|| 50`: likelihood = 0 («никогда») обязан остаться 0;
        // подмена на 50 допустима только при отсутствии аргумента.
     ...
     *
     * @param {Number} [min] Нижняя граница. Если передан только один аргумент, он считается верхней границей.
     * @param {Number} [max] Верхняя граница. По умолчанию MAX_INT.
     *
     * @return {Number}
     */
    ...
    /**
     * Возвращает случайный элемент массива array, либо count случайных элементов.
     *
     * @param {Array} array Массив.
     * @param {Number} [count] Сколько элементов выбрать. По умолчанию 1.
     *
     * @return {*|Array} Элемент или массив элементов.
     */
    pick: function(array, count) {
        count = count || 1;
        if (count == 1) {
