...
/**
 * Дополняет ведущим нулём число меньше 10. Числа 10 и выше возвращает без дополнения.
 *
 * @param {Number} n Число.
 *
 * @return {String} Число в виде строки, дополненное ведущим нулём.
 */
Bricks.Number.pad2 = function(n) {
    return (n < 10 ? '0' : '') + n;
};
