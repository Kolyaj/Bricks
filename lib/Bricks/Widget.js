 ...
 */
Bricks.Widget = Bricks.inherit(Bricks.AbstractWidget, {
    /**
     * @type String
     ...
     *
     * @param {Node/String} el Элемент, внутри которого находится экземпляр виджета.
     * @param {String} event Имя события.
    ...
    /**
     * Уничтожает виджет: снимает обработчики, генерирует событие 'destroy' и удаляет корневой элемент из DOM-дерева.
     */
    destroy: function() {
     ...
     * корневому элементу.
     *
     * @param {String} elClassName Имя класса элемента или имя добавляемого класса.
     ...
     * у корневого элемента.
     *
     * @param {String} elClassName Имя класса элемента или имя удаляемого класса.
     ...
     * элемента текущего виджета. Если el опущен, то события вешаются на корневой элемент.
     *
    ...
    /**
     * @param {String} event Имя события.
     * @param {Object} [data] Данные, расширяющие объект события.
     *
     * @return {Boolean} false, если событие было остановлено.
     */
