 ...
 *
 * @param {String} str Строка, в которой встречаются символы &, " и угловые скобки.
 *
 * @return {String} Строка, в которой эти символы экранированы HTML-сущностями.
 */
 ...
 *
 * @param {String} str Строка в dash-style.
 *
 * @return {String} Строка в camelStyle.
 */
 ...
 * camel-case-style.
 *
 * @param {String} str Строка в camelStyle.
 *
 * @return {String} Строка в dash-style.
 */
...
/**
 * Форматирует строку str, заменяя в ней шаблоны вида ${number}, где number -- натуральное число, на number + 1
 * по счету аргумент. Если $ экранирован символом \, то замена не производится.
 *
 * @param {String} str Строка с шаблонами.
 * @param {*} ...args Значения для шаблонов.
 *
 ...
 * @param {String} search Искомый префикс.
 *
 * @return {Boolean}
 */
 ...
 *
 * @param {String} str Проверяемая строка.
 * @param {String} search Искомый суффикс.
 *
 * @return {Boolean}
 */
 ...
 *      * <% Произвольный JS-код, например цикл: for (var i = 0; i < this.items.length; i++) { %> ... <% } %>. Код
 *         исполняется в контексте вызова результирующей функции, доступ к переменным контекста — через this.
