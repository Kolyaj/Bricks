/**
 * @deprecated
 * @type {{request: (function(String, String, (String|Object), Object, Function, Object): XMLHttpRequest | any), _encodeParams: (function(Object): string), arraySuffix: string, _createXHRObject: (function(): XMLHttpRequest|any)}}
 */
Bricks.XHR = {
    /**
    ...
    /**
     * @type {String}
     * Суффикс, добавляемый к имени параметра, если его значение является массивом.
     */
    arraySuffix: '[]',
