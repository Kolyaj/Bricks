//#require Bricks.AbstractWidget

//#require Bricks.getPrototypeChain
//#require Bricks.DOM.getEls
//#require Bricks.DOM.setStyle
//#require Bricks.DOM.getPos
...
//#require Bricks.DOM.toggleClassName
//#require Bricks.DOM.remove
//#require Bricks.DOM.isAncestor
...
Bricks.Widget = Bricks.AbstractWidget.inherit({
    ...
    _getEl: function(elClassName, force) {
        ...
        if (elClassName) {
            if (!this.$$_elementsCache[elClassName] || force) {
                this.$$_elementsCache[elClassName] = Bricks.DOM.getEls('!.' + elClassName, this._el);
            }
    ...
    _on: function(el, events, fn) {
        ...
        el = el || '';
        this._eventsController.on(typeof el == 'string' ? this._getEl(el) : el, events, fn, this);
    },
    ...
    _un: function(el, events, fn) {
        ...
        el = el || '';
        this._eventsController.un(typeof el == 'string' ? this._getEl(el) : el, events, fn, this);
    },
